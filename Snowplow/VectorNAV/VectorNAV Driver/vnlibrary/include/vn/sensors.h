...
typedef struct
{
	AsyncMode asyncMode;			/**< The asyncMode field. */        //SETS WHICH SERIAL PORT TO SEND FROM
	uint16_t rateDivisor;			/**< The rateDivisor field. */      //SETS RATE TO SEND OUT OF SERIAL PORT RELATIVE TO IMU RATE = 800HZ
