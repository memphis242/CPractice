...
${OBJECTDIR}/_ext/8055285/main.o: ../../../snowplow/drivers/old/GPS/main.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8055285/main.o ../../../snowplow/drivers/old/GPS/main.cpp

${OBJECTDIR}/_ext/7f3eff4c/main.o: ../../../snowplow/drivers/old/MotorController/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7f3eff4c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7f3eff4c/main.o ../../../snowplow/drivers/old/MotorController/main.cpp

${OBJECTDIR}/_ext/a5b8c547/EncoderInterface.o: ../../../snowplow/drivers/src/EncoderInterface.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/EncoderInterface.o ../../../snowplow/drivers/src/EncoderInterface.cpp

${OBJECTDIR}/_ext/a5b8c547/GpsInterface.o: ../../../snowplow/drivers/src/GpsInterface.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/GpsInterface.o ../../../snowplow/drivers/src/GpsInterface.cpp

${OBJECTDIR}/_ext/a5b8c547/LidarInterface.o: ../../../snowplow/drivers/src/LidarInterface.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/LidarInterface.o ../../../snowplow/drivers/src/LidarInterface.cpp

${OBJECTDIR}/_ext/a5b8c547/RS232_GenericController.o: ../../../snowplow/drivers/src/RS232_GenericController.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/RS232_GenericController.o ../../../snowplow/drivers/src/RS232_GenericController.cpp

${OBJECTDIR}/_ext/a5b8c547/RoboteQ.o: ../../../snowplow/drivers/src/RoboteQ.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/RoboteQ.o ../../../snowplow/drivers/src/RoboteQ.cpp

${OBJECTDIR}/_ext/a5b8c547/TCP_Connection.o: ../../../snowplow/drivers/src/TCP_Connection.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/TCP_Connection.o ../../../snowplow/drivers/src/TCP_Connection.cpp

${OBJECTDIR}/_ext/a5b8c547/XboxControllerInterface.o: ../../../snowplow/drivers/src/XboxControllerInterface.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a5b8c547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a5b8c547/XboxControllerInterface.o ../../../snowplow/drivers/src/XboxControllerInterface.cpp

${OBJECTDIR}/_ext/2db7bc07/Colors.o: ../../../snowplow/drivers/src/misc-libs/Colors.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/2db7bc07
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2db7bc07/Colors.o ../../../snowplow/drivers/src/misc-libs/Colors.cpp

${OBJECTDIR}/_ext/d3ef045a/encoderTest.o: ../../../snowplow/drivers/src/test/encoderTest.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d3ef045a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d3ef045a/encoderTest.o ../../../snowplow/drivers/src/test/encoderTest.cpp

${OBJECTDIR}/_ext/d3ef045a/rs232.o: ../../../snowplow/drivers/src/test/rs232.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d3ef045a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d3ef045a/rs232.o ../../../snowplow/drivers/src/test/rs232.cpp

${OBJECTDIR}/_ext/d3ef045a/sickSensor.o: ../../../snowplow/drivers/src/test/sickSensor.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d3ef045a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d3ef045a/sickSensor.o ../../../snowplow/drivers/src/test/sickSensor.cpp

${OBJECTDIR}/_ext/d3ef045a/xboxMotorBridge.o: ../../../snowplow/drivers/src/test/xboxMotorBridge.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d3ef045a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d3ef045a/xboxMotorBridge.o ../../../snowplow/drivers/src/test/xboxMotorBridge.cpp

${OBJECTDIR}/_ext/d3ef045a/xboxcontroller.o: ../../../snowplow/drivers/src/test/xboxcontroller.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d3ef045a
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d3ef045a/xboxcontroller.o ../../../snowplow/drivers/src/test/xboxcontroller.cpp
