...
${OBJECTDIR}/src/EncoderInterface.o: src/EncoderInterface.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EncoderInterface.o src/EncoderInterface.cpp

${OBJECTDIR}/src/RS232_GenericController.o: src/RS232_GenericController.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RS232_GenericController.o src/RS232_GenericController.cpp

${OBJECTDIR}/src/encoderTest.o: src/encoderTest.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/encoderTest.o src/encoderTest.cpp

${OBJECTDIR}/src/rs232.o: src/rs232.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/rs232.o src/rs232.cpp
